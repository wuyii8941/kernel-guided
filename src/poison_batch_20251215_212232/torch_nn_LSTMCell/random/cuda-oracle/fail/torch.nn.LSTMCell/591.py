...
arg_3_0_tensor = torch.rand([2, 10], dtype=torch.complex128)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([np.int64(1024)], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([np.int64(16)], dtype=torch.float32)
