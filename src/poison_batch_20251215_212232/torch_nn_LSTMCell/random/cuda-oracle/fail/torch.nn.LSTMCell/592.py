...
arg_3_0_tensor = torch.randint(-1,8,[np.int64(1024), 10], dtype=torch.int8)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([np.int64(16), 20], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([59, 20], dtype=torch.float32)
