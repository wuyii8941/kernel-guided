...
arg_3_0_tensor = torch.rand([2, 10, 1], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-32,16384,[np.int64(1024), 20, 1], dtype=torch.int16)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2, 20], dtype=torch.float64)
