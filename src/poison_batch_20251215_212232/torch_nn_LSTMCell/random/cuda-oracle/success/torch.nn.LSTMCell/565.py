...
arg_3_0_tensor = torch.randint(-1,32768,[2, 10, 0], dtype=torch.int64)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([63], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2], dtype=torch.float64)
