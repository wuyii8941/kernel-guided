...
arg_3_0_tensor = torch.rand([49, 10], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(0,1,[2, 8], dtype=torch.uint8)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([52, 20], dtype=torch.float32)
