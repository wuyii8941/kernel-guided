...
arg_3_0_tensor = torch.randint(-4096,256,[0], dtype=torch.int64)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-64,1024,[2, 20], dtype=torch.int16)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([48, 0], dtype=torch.float32)
