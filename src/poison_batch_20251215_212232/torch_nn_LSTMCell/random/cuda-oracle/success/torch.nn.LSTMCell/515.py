...
arg_3_0_tensor = torch.rand([2, 32], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([0, 20, 1], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.randint(-16384,32768,[2, 23], dtype=torch.int16)
