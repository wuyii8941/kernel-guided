...
arg_3_0_tensor = torch.rand([np.int64(1024), 10], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-4,256,[2], dtype=torch.int32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.randint(0,1,[0], dtype=torch.uint8)
