...
arg_3_0_tensor = torch.randint(-2,64,[2, 10, 0], dtype=torch.int8)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-128,16,[2, 20], dtype=torch.int8)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([63, 20], dtype=torch.float32)
