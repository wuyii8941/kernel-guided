...
arg_3_0_tensor = torch.randint(-128,2048,[2, 10], dtype=torch.int32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([0, 20, 0], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2], dtype=torch.float32)
