...
import time
arg_1 = 1
arg_2 = -3.759081733195794
arg_3 = 10
arg_4 = 0.4135814474927777
arg_class = torch.nn.GRU(input_size=arg_1,hidden_size=arg_2,num_layers=arg_3,batch_first=arg_4,)
arg_5_0_tensor = torch.randint(0,32,[99], dtype=torch.uint8)
arg_5_0 = arg_5_0_tensor.clone()
arg_5_1_tensor = torch.rand([1, 107, 133, 0], dtype=torch.float16)
