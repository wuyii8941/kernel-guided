...
arg_1 = 1
arg_2 = 1024
arg_3 = -0.6245016409070221
arg_4 = True
arg_class = torch.nn.GRU(input_size=arg_1,hidden_size=arg_2,num_layers=arg_3,batch_first=arg_4,)
arg_5_0_tensor = torch.randint(-8,8,[100, 0, 1], dtype=torch.int8)
arg_5_0 = arg_5_0_tensor.clone()
arg_5_1_tensor = torch.randint(-64,4,[np.int64(16), 100, 128], dtype=torch.int8)
