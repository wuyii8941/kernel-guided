...
arg_4_0_tensor = torch.randint(-2048,1024,[20, 32, 512, 1], dtype=torch.int16)
arg_4_0 = arg_4_0_tensor.clone()
arg_4_1_tensor = torch.rand([23, 32, 512], dtype=torch.float32)
arg_4_1 = arg_4_1_tensor.clone()
arg_4_2_tensor = torch.rand([13, 32, 512], dtype=torch.float32)
