...
arg_4_0_tensor = torch.rand([76, 65, 512], dtype=torch.float32)
arg_4_0 = arg_4_0_tensor.clone()
arg_4_1_tensor = torch.rand([22, 32, 512], dtype=torch.float32)
arg_4_1 = arg_4_1_tensor.clone()
arg_4_2_tensor = torch.randint(-32,8,[10, 0, 518, 1], dtype=torch.int8)
