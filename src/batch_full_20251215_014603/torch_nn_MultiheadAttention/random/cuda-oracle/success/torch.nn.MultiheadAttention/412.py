...
arg_4_0_tensor = torch.rand([10, 87, 512], dtype=torch.float32)
arg_4_0 = arg_4_0_tensor.clone()
arg_4_1_tensor = torch.rand([11, 83, 556], dtype=torch.float32)
arg_4_1 = arg_4_1_tensor.clone()
arg_4_2_tensor = torch.rand([0, 61], dtype=torch.float32)
