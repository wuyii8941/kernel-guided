...
arg_4_0_tensor = torch.rand([-1, 32, 16], dtype=torch.float32)
arg_4_0 = arg_4_0_tensor.clone()
arg_4_1_tensor = torch.rand([18, 0, 507], dtype=torch.float32)
arg_4_1 = arg_4_1_tensor.clone()
arg_4_2_tensor = torch.rand([20, 33], dtype=torch.float32)
