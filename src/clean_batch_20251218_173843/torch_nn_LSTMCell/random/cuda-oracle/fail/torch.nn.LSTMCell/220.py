...
arg_3_0_tensor = torch.rand([2, 21], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([2, 20], dtype=torch.float64)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.randint(-2,2,[2, 20], dtype=torch.int64)
