...
arg_3_0_tensor = torch.rand([2, 7], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-32,1,[0, 20], dtype=torch.int32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2, 77], dtype=torch.float32)
