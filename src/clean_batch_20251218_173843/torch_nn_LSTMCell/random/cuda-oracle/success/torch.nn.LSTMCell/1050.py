...
arg_3_0_tensor = torch.randint(-512,4,[0, 10], dtype=torch.int64)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([58], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.randint(-32,4,[0, 0, 1], dtype=torch.int16)
