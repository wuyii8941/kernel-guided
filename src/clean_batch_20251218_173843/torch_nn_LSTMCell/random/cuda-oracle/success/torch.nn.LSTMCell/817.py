...
arg_3_0_tensor = torch.randint(-16,4,[0, 50], dtype=torch.int16)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-1,128,[0, 20, 1], dtype=torch.int16)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([0, 20, 1], dtype=torch.float32)
