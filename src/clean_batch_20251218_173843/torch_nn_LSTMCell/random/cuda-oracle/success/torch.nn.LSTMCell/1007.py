...
arg_3_0_tensor = torch.rand([2, 30], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-1024,256,[2, 57, 0], dtype=torch.int16)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([17, 0, 1], dtype=torch.float32)
