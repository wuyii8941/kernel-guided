...
arg_3_0_tensor = torch.randint(-256,2048,[2, 10], dtype=torch.int32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(0,1,[0, 0], dtype=torch.uint8)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2], dtype=torch.complex64)
