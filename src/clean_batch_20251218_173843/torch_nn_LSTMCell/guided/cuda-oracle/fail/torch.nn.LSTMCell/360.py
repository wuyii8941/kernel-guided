...
arg_3_0_tensor = torch.randint(-32,32768,[0, 10], dtype=torch.int16)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.rand([16, 39], dtype=torch.float32)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.rand([2, 20, 1024], dtype=torch.float32)
