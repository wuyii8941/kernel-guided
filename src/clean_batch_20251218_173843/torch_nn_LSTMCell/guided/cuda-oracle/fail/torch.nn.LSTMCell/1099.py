...
arg_3_0_tensor = torch.rand([2, 31], dtype=torch.float32)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_0_tensor = torch.randint(-16384,64,[2], dtype=torch.int64)
arg_3_1_0 = arg_3_1_0_tensor.clone()
arg_3_1_1_tensor = torch.randint(-64,2,[2, 0, 1], dtype=torch.int8)
